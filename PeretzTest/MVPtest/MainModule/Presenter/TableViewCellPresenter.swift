...
protocol TableViewCellPresetnerProtocol: class {
    init(view: TableViewCellProtocol, networkService: NetworkServiceProtocol, userModel: UserSettings)
}
...
class TableViewCellPresenter: TableViewCellPresetnerProtocol {
    ...
    required init(view: TableViewCellProtocol, networkService: NetworkServiceProtocol, userModel: UserSettings) {
        self.view = view
        self.networkService = networkService
        self.userSettings = userModel
    }
}
